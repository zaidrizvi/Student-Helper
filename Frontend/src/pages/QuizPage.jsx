...
export default function QuizPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1628] px-3 pb-6 pt-20 text-slate-100 md:px-5 lg:px-6">
      <div className="mx-auto max-w-[1440px]">
        <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
          <div className="rounded-[28px] border border-slate-700/70 bg-[#142238] p-4 shadow-[0_30px_80px_-44px_rgba(2,12,27,0.95)] md:p-5">
            <div className="mb-5 flex items-center justify-between gap-4">
              ...
              <div className="shrink-0 text-right text-sm text-sky-200">
            ...
            <div className="rounded-[24px] border border-slate-700/70 bg-[#1b2d47] p-4 md:p-5">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <h2 className="mt-4 text-[1.6rem] font-bold leading-tight text-white md:text-[1.9rem]">
                    {question.question}
                  </h2>
                    ...
                    {question.options.map((option, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`flex items-start gap-3 rounded-[18px] border px-4 py-3 text-left transition-all ${
                            selected
                        ...
                        >
                          ...
                          <span className="flex-1 pt-0.5 text-[15px] leading-6 text-sky-50">{option}</span>
                        </motion.button>
                      );
                    })}
                  </div>
          ...
          <aside className="space-y-4">
            <div className="rounded-[28px] border border-slate-700/70 bg-[#142238] p-4 shadow-[0_30px_80px_-44px_rgba(2,12,27,0.95)]">
                ...
                {quizData.questions.map((_, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-[14px] px-0 py-3 text-sm font-bold transition-all ${
                        active
...
function ResultsView({ quizResults, onRetake, onExit, notesId }) {
  ...
  return (
    <div className="min-h-screen bg-[#0b1628] px-3 pb-8 pt-24 text-slate-100 md:px-5 lg:px-6">
      <div className="mx-auto flex max-w-[1320px] flex-col gap-3">
        <Panel className="shrink-0 p-3 text-center sm:p-4">
        
          <h1 className="mt-2 font-display text-[2rem] font-bold text-slate-950 dark:text-white sm:text-[2.3rem]">
        ...
        {quizResults.weakTopics?.length ? (
          <Panel className="p-3 sm:p-4">
            <div className="mb-3 shrink-0">
              ...
              <h2 className="mt-2 font-display text-[1.9rem] font-bold text-slate-950 dark:text-white">
